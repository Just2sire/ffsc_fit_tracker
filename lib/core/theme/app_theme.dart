...
/// Thème global FFSC Fit Tracker — palette "Lime & Ink".
class AppTheme {
  const AppTheme._();
  ...
  // ─────────────────────────────────────────────
  // TEXT THEMES — couleurs recalées sur le ColorScheme
  // (fontFamily par style déjà porté par AppTextStyles)
  // ─────────────────────────────────────────────
  ...
  static final lightTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        shadowColor: lightColorScheme.primary.withAlpha(102),
